...
const FragmentCard = ({
  ...
  return (
    <button
      ...
      className={cn(
        "flex items-start gap-2 border rounded-lg bg-muted w-fit p-3 text-start hover:bg-secondary transition-colors",
        isActiveFragment &&
    ...
    >
      ...
      <ChevronRightIcon className="size-3"></ChevronRightIcon>
      </div>
    </button>
  );
};
